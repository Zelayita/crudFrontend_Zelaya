//------ 1. Importamos los servicios para comunicacion con la API ----
import{
    getProducts,
    createProduct,
    updateProduct,
...
import{uploadImageToFolder} from '../services/imageServices.js'

// ------2. Variables globales de la paginacion --------
let currentPage = 0;
let currentSize = 10;

//Todo el documento ira aqui
document.addEventListener("DOMContentLoaded", () => {
    ...
    //Campos para Manejo de Imagenes
    ...
    //------ 4. Previsualizar la Imagen Seleccionada ----------
    ...
    //--- 6 Boton agregar resetea el formulario y abre el modal
    ...
    //------- 7. Submit del formulario (Crear/Actualizar porducto)
    form.addEventListener("submit", async(e) => {
        ...
        //------ 9. Construccion del payload para enviar a la API ------
        const payload = {
  ...
  //------ 13.  Cargar Categorias para el <select>---------
  ...
  //-------- 15. Resetear Formualrio (al agregar nuevo producto) ----------
